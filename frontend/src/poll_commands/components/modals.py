...
class MCPollModal(discord.ui.Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        """
        Callback function whenever the user submits their input for the modal for creating the poll question. Does
        some validation of the option field before embedding the question into the poll.
